...
export default function Home() {
  ...
  return (
    <div>
      <div className="first-div" ref={topRef}>
        ...
        <div className="authintication">
          <div className="container">
            <div className="authintication-box">
              <div className="authintication-box-main">
                <h2>Authenticate</h2>
                <form onSubmit={handleSubmit}>
                  <div className="authintication-box-input-flex">
                    <div className="authintication-box-input-flex-input">
                      <input type="email" name='email' value={formData.email} onChange={handleChange} placeholder='Enter Code' required />
                    </div>
      ...
      <div className="product-div">
          ...
          <div className="container3">
            ...
            <div className="features-div-light-grid">
              <div className="features-div-light-grid-box">
                <div className="features-light-box">
        ...
        <div className="aboutus">
          ...
          <div className="aboutus-div-light-grid">
            <div className="aboutus-div-light-grid-slide">
